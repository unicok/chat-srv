# chat(聊天）
[![Build Status](https://travis-ci.org/unicok/chat-srv.svg?branch=master)](https://travis-ci.org/unicok/char-srv)
...
4. Download and start the service
	...
	```shell
	go get github.com/unicok/char-srv
	./chat-srv --bolt_db_file="./CHAT.DAT" --max_queue_size=128
	```
